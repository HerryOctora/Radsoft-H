...
namespace RFSModel
{
    ...
    {
        public int CompanyPositionPK { get; set; }
    ...
    public class CompanyPositionCombo
    {
        public int CompanyPositionPK { get; set; }
    ...
    public class CompanyPositionScheme
    {
        public int CompanyPositionSchemePK { get; set; }
        public int CategorySchemePK { get; set; }
        public string CategorySchemeID { get; set; }
        public int CompanyPositionPK { get; set; }
        public string CompanyPositionID { get; set; }
