                ...
                if (session)
                {
                    try
                    {
                        ...
                        if (havePermission)
                        {
                            ...
                            {
                                int _lastPK = _investmentReps.InvestmentFifoBond_RejectSettlementBySelected(_investment);
  ...
  */
      ...
      */
                ...
                if (session)
                {
                    try
                    {
                        ...
                        if (havePermission)
                        {
                            ...
                            if (Tools.ClientCode == "03" || Tools.ClientCode == "20" || Tools.ClientCode == "21" || Tools.ClientCode == "22")
                            {
                                int _lastPK = _investmentReps.InvestmentFifoBond_RejectDealingBySelected(_investment);
        ...
        */
        ...
        [HttpPost]
        public HttpResponseMessage NettingReport(string param1, string param2, [FromBody]Investment _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        ...
                        if (_investmentReps.Netting_Report(param1, _investment))
                        {
            ...
            try
            {
                ...
                if (session)
                {
                    try
                    {
                        ...
                        {
                            return Request.CreateResponse(HttpStatusCode.OK, _customClient22.PTPBond_BySelectedData(param1, param3, param4, _investment));
                        }
                        else if (Tools.ClientCode == "25")
                        {
                        ...
                        {
                            return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.PTPBond_BySelectedData(param1, param3, param4, _investment));
                        }
            ...
            try
            {
                ...
                if (session)
                {
                    try
                    {
                        ...
                        {
                            return Request.CreateResponse(HttpStatusCode.OK, _customClient03.PTPDeposito_BySelectedData(param1, param3, param4, param5, _investment));
                        }
                        else
                        {
        ...
        [HttpPost]
        public HttpResponseMessage UpdateSettlementTimeDepositBuy(string param1, string param2, [FromBody] Investment _settlement)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        int _newHisPK = _investmentReps.Update_SettlementTimeDepositBuy(_settlement);
                        //_activityReps.Activity_LogInsert(DateTime.Now, PermissionID, true, "Update Retrieve Success", _Obj, "", param1, _department.DepartmentPK, _department.HistoryPK, _newHisPK, "UPDATE");
                        return Request.CreateResponse(HttpStatusCode.OK, "Update Settlement Success");
                    }
                    catch (Exception err)
        ...
        [HttpPost]
        public HttpResponseMessage UpdateSettlementTimeDepositSell(string param1, string param2, [FromBody] Investment _settlement)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        int _newHisPK = _investmentReps.Update_SettlementTimeDepositSell(_settlement);
                        //_activityReps.Activity_LogInsert(DateTime.Now, PermissionID, true, "Update Retrieve Success", _Obj, "", param1, _department.DepartmentPK, _department.HistoryPK, _newHisPK, "UPDATE");
                        return Request.CreateResponse(HttpStatusCode.OK, "Update Settlement Success");
                    }
                    catch (Exception err)
        ...
        [HttpPost]
        public HttpResponseMessage UpdatePTPMature(string param1, string param2, [FromBody] Investment _settlement)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        int _newHisPK = _investmentReps.Update_PTPMature(_settlement);
                        //_activityReps.Activity_LogInsert(DateTime.Now, PermissionID, true, "Update Retrieve Success", _Obj, "", param1, _department.DepartmentPK, _department.HistoryPK, _newHisPK, "UPDATE");
                        return Request.CreateResponse(HttpStatusCode.OK, "Update PTP Success");
                    }
                    catch (Exception err)
                    {
                        throw err;
...
*/
        ...
        [HttpGet]
        public HttpResponseMessage GetDataDealingByDateFromToBySummaryEquity(string param1, string param2, DateTime param3, DateTime param4)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.Get_DataDealingByDateFromToBySummaryEquity(param3, param4));
                    }
                    catch (Exception err)
                    {
        ...
        [HttpPost]
        public HttpResponseMessage GetPreviewGrouping(string param1, string param2, [FromBody]InvestmentPreviewGrouping _listing)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        _investmentReps.get_PreviewGrouping(param1, _listing);
                        return Request.CreateResponse(HttpStatusCode.OK, "Grouping Success");
                    }
                    catch (Exception err)
                    {
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Grouping Bulk Equity Rpt", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        [HttpGet]
        public HttpResponseMessage DeleteBulkOrderEquity(string param1, string param2, int param3)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.DeleteBulkOrderEquity(param3));
                    }
                    catch (Exception err)
                    {
        ...
        [HttpGet]
        public HttpResponseMessage GetBulkOrderEquity(string param1, string param2, DateTime param3)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.GetBulkOrderEquity(param3));
                    }
                    catch (Exception err)
                    {
        ...
        [HttpPost]
        public HttpResponseMessage ValidateUpdateBrokerBySelectedDataBulkEquity(string param1, string param2, [FromBody]Investment _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.Validate_UpdateBrokerBySelectedDataBulkEquity(_investment));
                    }
                    catch (Exception err)
                    {
                        throw err;
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Validate Update Broker By Bulk Equity", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        [HttpPost]
        public HttpResponseMessage ValidateCounterpartPercentageBulkEquity(string param1, string param2, [FromBody]Investment _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.Validate_CounterpartPercentageBulkEquity(_investment));
                    }
                    catch (Exception err)
                    {
                        throw err;
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Validate Check Exposure By Bulk Equity", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        /*
          ...
          */
        [HttpPost]
        public HttpResponseMessage UpdateCounterpartBySelectedBulkEquity(string param1, string param2, [FromBody]Investment _investment)
        {
            string PermissionID;
            PermissionID = "DealingInstruction_UpdateCounterpartBySelected";
            try
            {
                ...
                if (session)
                {
                    try
                    {
                        ...
                        {
                            bool havePrivillege = _host.Get_Privillege(param1, PermissionID);
                            int _lastPK = _investmentReps.Investment_UpdateCounterpartBySelectedBulkEquity(_investment);
                            _activityReps.Activity_LogInsert(DateTime.Now, PermissionID, true, "Update Counterpart By Bulk Equity Success", _Obj, "", param1, _lastPK, 0, 0, "INSERT");
                            return Request.CreateResponse(HttpStatusCode.OK, _lastPK);
                        }
                        else
                        {
        ...
        [HttpGet]
        public HttpResponseMessage GetSplitBulkOrderEquity(string param1, string param2, int param3)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.GetSplitBulkOrderEquity(param3));
                    }
                    catch (Exception err)
                    {
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Get Split Bulk Order Equity", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        [HttpGet]
        public HttpResponseMessage DeleteSplitBulkOrderEquity(string param1, string param2, int param3, int param4)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.DeleteSplitBulkOrderEquity(param3, param4));
                    }
                    catch (Exception err)
                    {
        ...
        [HttpPost]
        public HttpResponseMessage ValidateSplitVolumeByBulkOrderEquity(string param1, string param2, [FromBody]InvestmentPreviewGrouping _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.ValidateSplitVolumeByBulkOrderEquity(_investment));
                    }
                    catch (Exception err)
                    {
                        throw err;
        ...
        [HttpPost]
        public HttpResponseMessage AddSplitBulkOrderEquity(string param1, string param2, [FromBody]InvestmentPreviewGrouping _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.AddSplitBulkOrderEquity(_investment));
                    }
                    catch (Exception err)
                    {
                        throw err;
        ...
        [HttpGet]
        public HttpResponseMessage GetDataForMatchBulkEquity(string param1, string param2, int param3)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.GetDataForMatchBulkEquity(param3));
                    }
                    catch (Exception err)
                    {
        ...
        [HttpPost]
        public string UpdateMatchByBulkOrderEquity(string param1, string param2, [FromBody]List<InvestmentPreviewGrouping> _InvestmentPreviewGrouping)
        {
            string _msg = "";
            try
            {
                ...
                if (session)
                {
                    try
                    {
                        try
                        {
                            return _msg = _investmentReps.Investment_UpdateMatchByBulkOrderEquity(param1,_InvestmentPreviewGrouping);
                        }
                        catch (Exception err)
                        {
                            throw err;
        ...
        [HttpGet]
        public HttpResponseMessage ValidateMatchByBulkOrderEquity(string param1, string param2, int param3)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.ValidateMatchByBulkOrderEquity(param3));
                    }
                    catch (Exception err)
                    {
                        throw err;
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Validate Check Status Split By Bulk Equity", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        [HttpPost]
        public HttpResponseMessage ValidateCounterpartByFundPK(string param1, string param2, [FromBody]Investment _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.Validate_CounterpartByFundPK(_investment));
                    }
                    catch (Exception err)
                    {
                        throw err;
        ...
        [HttpPost]
        public HttpResponseMessage UnmatchBulkEquity(string param1, string param2, [FromBody]Investment _investment)
        {
            string PermissionID;
            PermissionID = "DealingInstruction_UnApproveDealingBySelected";
            try
            {
                ...
                if (session)
                {
                    try
                    {
                        ...
                        {
                            bool havePrivillege = _host.Get_Privillege(param1, PermissionID);
                            int _lastPK = _investmentReps.Investment_UnMatchBulkEquity(_investment);
                            _activityReps.Activity_LogInsert(DateTime.Now, PermissionID, true, "Unmatch Bulk Equity Success", _Obj, "", param1, _lastPK, 0, 0, "INSERT");
                            return Request.CreateResponse(HttpStatusCode.OK, _lastPK);
                        }
                        else
                        {
        ...
        [HttpPost]
        public HttpResponseMessage GetRecalSplitRemainingAmount(string param1, string param2, [FromBody]Investment _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.Get_RecalSplitRemainingAmount(_investment));
                    }
                    catch (Exception err)
                    {
                        throw err;
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Get Remaining Amount", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        [HttpPost]
        public HttpResponseMessage PTPByBondUSD(string param1, string param2, DateTime param3, DateTime param4, [FromBody]Investment _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.PTPBondUSD_BySelectedData(param1, param3, param4, _investment));
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "PTP Bond USD Rpt BySelectedData", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        [HttpGet]
        public HttpResponseMessage GetDataAmmendDepositoFromSettlement(string param1, string param2, DateTime param3, DateTime param4)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.GetDataAmmendDeposito(param3, param4));
                    }
                    catch (Exception err)
                    {
        ...
        [HttpPost]
        public HttpResponseMessage Settlement_AmmendDeposito(string param1, string param2, [FromBody]InvestmentAmmendMature _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        _activityReps.Activity_LogInsert(DateTime.Now, "SettlementInstruction_U", true, "Settlement Ammend PaymentModeOnMaturity By Selected Data", _Obj, "", param1, 0, 0, 0, "INSERT");
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.Settlement_AmmendDeposito(_investment));
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Settlement Ammend PaymentModeOnMaturity By Selected Data", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        [HttpPost]
        public HttpResponseMessage PTPByEBA(string param1, string param2, DateTime param3, DateTime param4, [FromBody]Investment _investment)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        if (Tools.ClientCode == "03" || Tools.ClientCode == "20" || Tools.ClientCode == "21" || Tools.ClientCode == "22")
                        {
                            return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.PTPEBAFifoBond_BySelectedData(param1, param3, param4, _investment));
                        }
                        else
                        {
                            return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.PTPEBA_BySelectedData(param1, param3, param4, _investment));
                        }
        ...
        [HttpGet]
        public HttpResponseMessage GetInvestmentPKFromCrossFund(string param1, string param2, int param3, int param4)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.Get_InvestmentPKFromCrossFund(param3, param4));
                    }
                    catch (Exception err)
                    {
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Get InvestmentPK From CrossFund", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
        ...
        [HttpGet]
        public HttpResponseMessage GetAcqDateBeforeForRollover(string param1, string param2, int param3)
        {
            try
            {
                bool session = Tools.SessionCheck(param1, param2);
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _investmentReps.Get_AcqDateBeforeForRollover(param3));
                    }
                    catch (Exception err)
                    {
                ...
                {
                    _activityReps.Activity_LogInsert(DateTime.Now, "", false, Tools.NoSessionLogMessage, _Obj, "Get AcqDate Before For Rollover", param1, 0, 0, 0, "");
                    return Request.CreateResponse(HttpStatusCode.NotFound, Tools.NoSessionMessage);
                }
            }
            catch (Exception err)
