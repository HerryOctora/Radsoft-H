...
{
    public class FundUnitPositionController : ApiController
    {
        static readonly string _Obj = "Fund Client Position Controller";
        static readonly FundUnitPositionReps _FundUnitPositionReps = new FundUnitPositionReps();
            ...
            try
            {
                ...
                if (session)
                {
                    ...
                    try
                    {
                        ...
                        return Request.CreateResponse(HttpStatusCode.OK, _FundUnitPositionReps.FundUnitPosition_SelectByDateFromTo(param3, param4, param5));
                    }
                    catch (Exception err)
                    {
                        throw err;
        ...
        public HttpResponseMessage ValidateCashAmountByDate(string param1, string param2, int param3, int param4, DateTime param5)
        {
            try
            {
                ...
                if (session)
                {
                    try
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, _FundUnitPositionReps.Validate_CashAmountByDate(param3, param4, param5));
                    }
                    catch (Exception err)
                    {
                        throw err;
