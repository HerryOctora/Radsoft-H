...
namespace W1.Controllers
{
    ...
    {
        static readonly string _Obj = "Customer Dashboard Controller";
        static readonly CustomerDashboardReps _customerDashboardReps = new CustomerDashboardReps();
            ...
            try
            {
                ...
                if (session)
                {
                    ...
                    try
                    {
                        ...
                        return Request.CreateResponse(HttpStatusCode.OK, _customerDashboardReps.CustomerDashboard_SelectByDate(param3, param4));
                    }
                    catch (Exception err)
                    {
                        throw err;
