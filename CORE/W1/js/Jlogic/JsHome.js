$(document).ready(function () {
    ...
    if (_GlobClientCode == '20') {
        _dormantAccount = "Pooling Account"
    }
    else {
        _dormantAccount = "Dormant Account"
    }
    ...
    $("#MenuSearch").kendoComboBox({
        ...
        dataSource: [
            ...
            { text: _dormantAccount, value: "DormantAccount" },
            ...
            { text: "Exposure Monitoring Detail", value: "ExposureMonitoringDetail" },
            ...
            { text: "Fund Client Data Master", value: "FundClientAffiliated" },
            ...
            { text: "Bond Information From IBPA", value: "BondInformationFromIBPA" },
            ...
            { text: "KYC Risk Profile Score Setup", value: "KYCRiskProfileScoreSetup" },
            { text: "MFeeSetupOptional", value: "MFeeSetupOptional" },
            { text: "FFS For OJK", value: "FFSForOJK" },
            { text: "Budget", value: "Budget" },
            { text: "Item Budget", value: "ItemBudget" },
            { text: "AUM For Budget Beg Balance", value: "AumForBudgetBegBalance" },
            { text: "Revenue", value: "Revenue" },
            { text: "Dormant Fund Trails", value: "DormantFundTrails" },
            { text: "Agent CSR BegBalance", value: "AgentCSRBegBalance" },
            { text: "Close NAV Infovesta", value: "CloseNAVInfovesta" },
            { text: "RKAP Accounting", value: "RKAPAccounting" },
            { text: "Fund Client Consignee Mapping", value: "FundClientConsigneeMapping" },
            { text: "Budget Versioning", value: "BudgetVersioning" },
            { text: "Type Of Assets", value: "TypeOfAssets" },
            { text: "Daily Transaction For Investment", value: "DailyTransactionForInvestment" },
            { text: "Budget Summary", value: "BudgetSummary" }, 
    ...
    function OpenForm(item) {
        ...
        if (item == "FundClientDataMaster") {
            item = "FundClientAffiliated";
        }
                ...
                success: function (data) {
                    if (data == true) {
                        if (item == "AgentUsers"
                            ...
                            || item == "KYCRiskProfileScoreSetup"
                            || item == "MFeeSetupOptional"
                            || item == "FundClientAffiliated"
                            || item == "FFSForOJK"
                            || item == "Budget"
                            || item == "ItemBudget"
                            || item == "AumForBudgetBegBalance"
                            || item == "Revenue"
                            || item == "DormantFundTrails"
                            || item == "AgentCSRBegBalance"
                            || item == "CloseNAVInfovesta"
                            || item == "RKAPAccounting"
                            || item == "BudgetVersioning"
                            || item == "TypeOfAssets"
                            || item == "BudgetSummary"

                        ) {
                            
                            if (_GlobClientCode == '20' && item == "FundClient") {
                                    $("#Frame").attr("src", "../../WEB/CustomClient20/" + item + ".html");
                            } else {
                            ...
                            || item == "CurrencyReval"
                            || item == "FundClientConsigneeMapping"
                            ...
                            || item == "DailyTransactionForInvestment"
                        )
                        {
    ...
    function InitMenu() {
        ...
        if (_GlobClientCode == '03') {
            ...
            $("#LblBondInformationFromIBPA").show();
        }
            ...
            $("#Administrator").show();
            $("#LblCustomerDashboard").show();
            $("#LblDailyTransactionForInvestmentUR").show();
        }
            ...
            //Accounting
            $("#LblAccountLedgerBalance").hide();
            $("#LblTrxPortfolio").hide();
            $("#LblPortfolioRevaluation").hide();
            $("#LblRL504").hide();
            $("#LblRL510CEquity").hide();
            $("#LblRL510CBond").hide();
            $("#LblRL510CSbn").hide();

            //AccountingMaster
            $("#LblAccountBudget").hide();
            $("#LblAUMAccounting").hide();
            $("#LblBank").hide();
            $("#LblBankBranch").hide();
            $("#LblClosePrice").hide();
            ...
            $("#LblMarket").hide();
            $("#LblPeriod").hide();
            $("#LblConsigneeMapping").hide();
            $("#LblRKAPAccounting").hide();

            //Fund Admin
            $("#LblImportFxd").hide();
            $("#LblRetreiveFromBridge").hide();
            $("#LblFundClientDataMaster").hide();
            $("#LblBondInformationFromIBPA").hide();
            $("#LblAgentFundPosition").hide();
            $("#LblExposureMonitoring").hide();
            $("#LblCouponScheduler").hide();
            $("#LblGenerateUnitFeeSummary").hide();
            $("#LblFIFOBondPosition").hide();
            $("#LblFundAvgPriority").hide();
            $("#LblDormantFundTrails").hide();
            $("#LblCloseNAVInfovesta").hide();

            //Fund Admin Master
            $("#LblAgentCSRFund").hide();
            $("#LblAUMFundAdmin").hide();
            $("#LblBenchmarkIndex").hide();
            $("#LblBloombergEquity").hide();
            $("#LblBoard").hide();
            $("#LblBusinessType").hide();
            $("#LblCounterpart").hide();
            $("#LblCounterpartCommission").hide();
            $("#LblCustodianJournalAccountName").hide();
            $("#LblFundExposure").hide();
            $("#LblFFSForOJK").hide();
            $("#LblFundRiskProfile").hide();
            $("#LblIndex").hide();
            $("#LblNavMappingReport").hide();
            $("#LblReksadanaType").hide();
            $("#LblReksadanaInstrument").hide();
            $("#LblTemplateReport").hide();

            //UnitRegistryMaster
            $("#LblAgentCSRFundUR").hide();
            $("#LblAgentCSRBegBalanceUR").hide();
            $("#LblInstrumentCompanyTypeUR").hide();
            $("#LblBenchmarkIndexUR").hide();
            $("#LblBlackListNameUR").hide();
            $("#LblCAMInterfaceUR").hide();
            $("#LblClosePriceUR").hide();
            $("#LblCategoryScheme").hide();
            $("#LblCompanyPosition").hide();
            $("#LblDailyDataCommissionUR").hide();
            $("#LblFundUR").hide();
            $("#LblFundCashRefUR").hide();
            $("#LblFundRiskProfileUR").hide();
            $("#LblInternalCategoryUR").hide();
            $("#LblManageInvestmentUR").hide();
            $("#LblRiskProfileScoreUR").hide();
            $("#LblRiskQuestionnaireUR").hide();
            $("#LblRiskQuestinnaireAnswerUR").hide();
            $("#LblKYCRIskProfileScoreSetupUR").hide();
            $("#LblMFeeSetupOptionalUR").hide();
            $("#LblInsuranceProductUR").hide();
            $("#LblTrxUnitPaymentProviderUR").hide();
            $("#LblTrxUnitPaymentTypeUR").hide();
            $("#LblTrxUnitPaymentMappingUR").hide();

            //UnitRegistry
            $("#LblDormantAccountUR ").show();
            $("#LblFundClientBankListUR").hide();
            $("#LblFundClientVerification").hide();
            $("#LblSubsWithInterest").hide();
            $("#LblRiskProfileMonitoringUR").hide();
            $("#LblCustomerDashboard").hide();
            $("#LblBackLoadSetupUR").hide();
            $("#LblHoldingPeriodUR").hide();

            //Finance
            $("#LblTrxPortfolioF").show();
            $("#LblTypeOfAssets").show();

            //FinanceMaster
            $("#LblPeriodF").hide();

            //Invesment
            $("#LblFundAdminRptINV").hide();
            $("#LblDirectInvestmentINV").hide();
            $("#LblAdvisoryFeeINV").hide();
            $("#LblExposireMonitoringDetailINV").hide();

            //InvestmentMaster
            $("#LblMarketINV").hide();
            $("#LblMarketHolidayINV").hide();
            $("#LblFundINV").hide();

            //Dealing
            $("#LblFundAdminRptDeal").hide();

            //DealingMaster
            $("#LblBenchmarkIndexDeal").hide();
            $("#LblBoardDeal").hide();
            $("#LblBusinessTypeDeal").hide();
            $("#LblCloseNavDeal").hide();
            $("#LblClosePriceDeal").hide();
            $("#LblFundDeal").hide();
            $("#LblFundExposureDeal").hide();
            $("#LblMarketDeal").hide();

            //Settlement
            $("#LblExposureMonitoringSet").hide();
            $("#LblNotificationSet").hide();
            $("#LblImportTrxFromBKSet").hide();

            //SettlementMaster
            $("#LblBenchmarkIndexSet").hide();
            $("#LblBoardSet").hide();
            $("#LblBusinessTypeSet").hide();
            $("#LblCloseNavSet").hide();
            $("#LblClosePriceSet").hide();
            $("#LblCurrencySet").hide();
            $("#LblCurrencyRateSet").hide();
            $("#LblFundSet").hide();
            $("#LblFundExposureSet").hide();
            $("#LblMarketSet").hide();
            $("#LblMarkeHolidaySet").hide();
        }
    ...
    function ResetMenu() {
        ...
        //24
        $("#LblDailyTransactionForInvestmentUR").hide();

        //33
        $("#LblDormantAccountUR ").hide();
        $("#LblTrxPortfolioF").hide();
        $("#LblTypeOfAssets").hide();
    }
