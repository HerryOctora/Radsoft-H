$(document).ready(function () {
    ...
    if (_GlobClientCode == '25' || _GlobClientCode == '14') {
    ...
    if (_GlobClientCode == "20") {
        ...
        $("#lblRiskApetiteProfile").hide();
        $("#lblKYCRiskProfile").hide();

        $("#SubstantialOwnerName").hide();
        $("#SubstantialOwnerAddress").hide();
        $("#SubstantialOwnerTIN").hide();

        $("#lblSpouseBirthPlace").hide();
        $("#lblOtherTeleponRumah").hide();
        $("#lblOtherTeleponSelular").hide();
        $("#lblOtherFax").hide();
        $("#lblOtherEmail").hide();
        $("#lblSpouseNationality").hide();
        

        $("#NPWP").attr("required", false);
        $("#RegistrationNPWP").attr("required", false);

        $("#BeneficialName").attr("required", false);
        $("#BeneficialAddress").attr("required", false);
        $("#BeneficialIdentity").attr("required", false);
        $("#BeneficialWork").attr("required", false);
        $("#BeneficialRelation").attr("required", false);
        $("#BeneficialHomeNo").attr("required", false);
        $("#BeneficialPhoneNumber").attr("required", false);
        $("#BeneficialNPWP").attr("required", false);

        $("#NoSKD").attr("required", false);
        $("#ExpiredDateSKD").attr("required", false);
        $("#NomorAnggaran").attr("required", false);

        $("#NPWPPerson1").attr("required", false);
        $("#IdentityTypeOfficer1").attr("required", false);
        $("#NoIdentitasOfficer1").attr("required", false);

        $("#IdentityTypeOfficer2").attr("required", false);
        $("#NoIdentitasOfficer2").attr("required", false);

        $("#IdentityTypeOfficer3").attr("required", false);
        $("#NoIdentitasOfficer3").attr("required", false);

        $("#IdentityTypeOfficer4").attr("required", false);
        $("#NoIdentitasOfficer4").attr("required", false);
        ...
        $("#lblIdentity2").hide();
        $("#lblHeaderIdentity34").hide();
        $("#lblIdentity34").hide();

        $("#lblIdentity22").hide();
        $("#lblHeaderIdentity2324").hide();
        $("#lblIdentity2324").hide();

        $("#lblIdentity32").hide();
        $("#lblHeaderIdentity3334").hide();
        $("#lblIdentity3334").hide();

        $("#lblHeaderIdentity1112").hide();
        $("#lblIdentity1112").hide();
        $("#lblHeaderIdentity2122").hide();
        $("#lblIdentity2122").hide();
        $("#lblHeaderIdentity3132").hide();
        $("#lblIdentity3132").hide();
        $("#lblHeaderIdentity4142").hide();
        $("#lblIdentity4142").hide();

        $("#lblIdentity42").hide();
        $("#lblHeaderIdentity4344").hide();
        $("#lblIdentity4344").hide();



        $("#FATCA").attr("required", false);
        $("#TIN").attr("required", false);
        $("#TINIssuanceCountry").attr("required", false);
        $("#GIIN").attr("required", false);
        $("#AlamatTIN").attr("required", false);

        $("#TeleponRumah").attr("required", false);
        $("#TeleponSelular").attr("required", false);
        $("#ExpiredDateIdentitasInd1").attr("required", false);
        $("#OtherPropinsiInd1").attr("required", false);
        $("#OtherNegaraInd1").attr("required", false);
        $("#Propinsi").attr("required", false);
        $("#CountryofCorrespondence").attr("required", false);
        $("#AlamatInd2").attr("required", false);
        $("#KodeKotaInd2").attr("required", false);
        $("#KodeDomisiliPropinsi").attr("required", false);
        $("#CountryofDomicile").attr("required", false);
        ...
        $("#lblIncomeInformation").hide();
        $("#IncomeInformation").attr("required", false);

        $("#lblSpouseParentSourceOfFund").hide();
        $("#lblHeir").hide();
        $("#lblHeirRelationship2").hide();

        $("#SpouseName").attr("required", false);
        $("#SpouseDateOfBirth").attr("required", false);
        $("#SpouseParentIDNumber").attr("required", false);
        $("#SpouseOccupation").attr("required", false);
        $("#OtherSpouseOccupation").attr("required", false);
        $("#SpouseParentCompanyName").attr("required", false);
        $("#SpouseNatureOfBusiness").attr("required", false);
        $("#SpouseParentOfficePosition").attr("required", false);
        $("#SpouseParentCompanyAddress").attr("required", false);
        $("#SpouseAnnualIncome").attr("required", false);
        $("#SpouseParentSourceOfFund").attr("required", false);

        $("#lblHeirRelationship2").hide();
        $("#lblHeir2").hide();
        $("#lblSpouseParentSourceOfFund").hide();
        $("#lblSpouseParentOfficePosition").hide();
        $("#lblSpouseParentCompanyAddress").hide();
        $("#lblSpouseParentCompanyName").hide();
        $("#lblSpouseParentIDNumber").hide();
        ...
        $("#NamaKantor").attr("required", false);
        $("#JabatanKantor").attr("required", false);
        $("#TeleponKantor").attr("required", false);
        $("#AlamatKantorInd").attr("required", false);
        $("#KodeKotaKantorInd").attr("required", false);
        $("#KodePropinsiKantorInd").attr("required", false);
        $("#KodeCountryofKantor").attr("required", false);
        $("#KodePosKantorInd").attr("required", false);

        $("#BeneficialName1").attr("required", false);
        $("#BeneficialName2").attr("required", false);
        $("#BeneficialName3").attr("required", false);

        $("#BeneficialAddress1").attr("required", false);
        $("#BeneficialAddress2").attr("required", false);
        $("#BeneficialAddress3").attr("required", false);

        $("#BeneficialIdentity1").attr("required", false);
        $("#BeneficialIdentity2").attr("required", false);
        $("#BeneficialIdentity3").attr("required", false);

        $("#BeneficialRelation1").attr("required", false);
        $("#BeneficialRelation2").attr("required", false);
        $("#BeneficialRelation3").attr("required", false);

        $("#BeneficialNPWP1").attr("required", false);
        $("#BeneficialNPWP2").attr("required", false);
        $("#BeneficialNPWP3").attr("required", false);

        $("#BeneficialIdentitasInd").attr("required", false);  //baru
        $("#BeneficialIdentitasInd1").attr("required", false); //baru
        $("#BeneficialIdentitasInd2").attr("required", false); //baru
        $("#BeneficialIdentitasInd3").attr("required", false); //baru

        $("#lblAPUPPTOccupation").show();
        $("#lblNatureOfBusiness").hide();
        $("#NatureOfBusiness").attr("required", false);
    }
    else {
        $("#lblRiskProfileScore").show();
        $("#lblRiskApetiteProfile").show();
        $("#lblKYCRiskProfile").show();

        $("#SubstantialOwnerName").show();
        $("#SubstantialOwnerAddress").show();
        $("#SubstantialOwnerTIN").show();
        ...
        $("#lblIdentity2").show();
        $("#lblHeaderIdentity34").show();
        $("#lblIdentity34").show();

        $("#lblIdentity22").show();
        $("#lblHeaderIdentity2324").show();
        $("#lblIdentity2324").show();

        $("#lblIdentity32").show();
        $("#lblHeaderIdentity3334").show();
        $("#lblIdentity3334").show();

        $("#lblHeaderIdentity1112").hide();
        $("#lblIdentity1112").hide();
        $("#lblHeaderIdentity2122").hide();
        $("#lblIdentity2122").hide();
        $("#lblHeaderIdentity3132").show();
        $("#lblIdentity3132").show();
        $("#lblHeaderIdentity4142").show();
        $("#lblIdentity4142").show();

        $("#lblIdentity42").show();
        $("#lblHeaderIdentity4344").show();
        $("#lblIdentity4344").show();
    ...
    function setFundClient(data) {
        ...
        $("#BeneficialName1").val(data.BeneficialName1);
        $("#BeneficialName2").val(data.BeneficialName2);
        $("#BeneficialName3").val(data.BeneficialName3);

        $("#BeneficialAddress1").val(data.BeneficialAddress1);
        $("#BeneficialAddress2").val(data.BeneficialAddress2);
        $("#BeneficialAddress3").val(data.BeneficialAddress3);

        $("#BeneficialIdentity1").val(data.BeneficialIdentity1);
        $("#BeneficialIdentity2").val(data.BeneficialIdentity2);
        $("#BeneficialIdentity3").val(data.BeneficialIdentity3);

        $("#BeneficialRelation1").val(data.BeneficialRelation1);
        $("#BeneficialRelation2").val(data.BeneficialRelation2);
        $("#BeneficialRelation3").val(data.BeneficialRelation3);

        $("#BeneficialNPWP1").val(data.BeneficialNPWP1);
        $("#BeneficialNPWP2").val(data.BeneficialNPWP2);
        $("#BeneficialNPWP3").val(data.BeneficialNPWP3);
        ...
        if (data.InvestorType == 1) {
            ...
            if (_GlobClientCode == "20") {
                ...
                $("#lblIncomeInformation").show();
                $("#IncomeInformation").attr("required", true);
                ...
                $("#TeleponKantor").attr("required", false);
                $("#AlamatKantorInd").attr("required", false);
                $("#KodeKotaKantorInd").attr("required", true);
                $("#KodePropinsiKantorInd").attr("required", true);
                $("#KodeCountryofKantor").attr("required", true);
                $("#KodePosKantorInd").attr("required", false);
                ...
                $("#BeneficialIdentitasInd").attr("required", false);
                $("#BeneficialIdentitasInd1").attr("required", false);
                $("#BeneficialIdentitasInd2").attr("required", false);
                $("#BeneficialIdentitasInd3").attr("required", false);
                ...
                $("#lblHeaderIdentity1112").show();
                $("#lblIdentity1112").show();
                $("#lblHeaderIdentity2122").show();
                $("#lblIdentity2122").show();
                $("#lblHeaderIdentity3132").show();
                $("#lblIdentity3132").show();
                $("#lblHeaderIdentity4142").show();
                $("#lblIdentity4142").show();
            ...
            if (_GlobClientCode == "20") {
                ...
                $("#ExpiredDateSKD").attr("required", true);
                $("#NomorAnggaran").attr("required", true);

                $("#NPWPPerson1").attr("required", true);
                $("#IdentityTypeOfficer1").attr("required", true);
                $("#NoIdentitasOfficer1").attr("required", true);
        ...
        $("#FATCACRS").val(data.FATCACRS);
        $("#AlamatTIN").val(data.AlamatTIN);
        $("#IncomeInformation").val(data.IncomeInformation);

        $("#BeneficialIdentitasInd").val(data.BeneficialIdentitasInd);
        $("#BeneficialIdentitasInd1").val(data.BeneficialIdentitasInd1);
        $("#BeneficialIdentitasInd2").val(data.BeneficialIdentitasInd2);
        $("#BeneficialIdentitasInd3").val(data.BeneficialIdentitasInd3);

        $("#SpouseParentSourceOfFund").val(data.SpouseParentSourceOfFund);
        $("#Heir").val(data.Heir);
        $("#HeirRelationship2").val(data.HeirRelationship2);

        $("#SpouseParentIDNumber").val(data.SpouseParentIDNumber);
        $("#SpouseParentCompanyName").val(data.SpouseParentCompanyName);
        $("#SpouseParentOfficePosition").val(data.SpouseParentOfficePosition);
        $("#SpouseParentCompanyAddress").val(data.SpouseParentCompanyAddress);
        ...
        if ($("#Pekerjaan").val() == 1 || $("#Pekerjaan").val() == 2 || $("#Pekerjaan").val() == 6) {
            ...
            if (this.value() && this.selectedIndex == -1) {
                ...
                if ($("#InvestorType").data("kendoComboBox").value() == 1) {
                    ...
                    if (_GlobClientCode == "20") {
                        ...
                        $("#lblSpouseParentSourceOfFund").show();
                        $("#lblHeir").show();
                        $("#lblHeirRelationship2").show();
                    ...
                    if (_GlobClientCode == "20") {
                        ...
                        $("#lblNatureOfBusiness").hide();
                        $("#NatureOfBusiness").attr("required", false);
                        if ($("#NamaDepanIns2").val().length > 0) {
                            $("#IdentityTypeOfficer2").attr("required", true);
                            $("#NoIdentitasOfficer2").attr("required", true);
                        }
                        else {
                            $("#IdentityTypeOfficer2").attr("required", false);
                            $("#NoIdentitasOfficer2").attr("required", false);
                        ...
                        if ($("#NamaDepanIns3").val().length > 0) {
                            $("#IdentityTypeOfficer3").attr("required", true);
                            $("#NoIdentitasOfficer3").attr("required", true);
                        }
                        else {
                            $("#IdentityTypeOfficer3").attr("required", false);
                            $("#NoIdentitasOfficer3").attr("required", false);
                        ...
                        if ($("#NamaDepanIns4").val().length > 0) {
                            $("#IdentityTypeOfficer4").attr("required", true);
                            $("#NoIdentitasOfficer4").attr("required", true);
                        }
                        else {
                            $("#IdentityTypeOfficer4").attr("required", false);
                            $("#NoIdentitasOfficer4").attr("required", false);
        ...
        $("#FATCACRS").kendoComboBox({
            ...
            filter: "contains",
            suggest: true,
            change: OnChangeFATCACRS,
            value: setCmbFATCACRS()
        });
        function OnChangeFATCACRS() {
            if (this.value() && this.selectedIndex == -1) {
                var dt = this.dataSource._data[0];
                this.text('');
            }
            if ($("#FATCACRS").data("kendoComboBox").value() == 1) {
                $("#FATCA").data("kendoComboBox").enable(true);
                $("#TIN").attr('readonly', false);
                $('#btnListTINIssuanceCountry').attr("disabled", false);
                $("#GIIN").attr('readonly', false);
                $("#AlamatTIN").attr('readonly', false);

                $("#FATCA").attr("required", true);
                $("#TIN").attr("required", true);
                $("#TINIssuanceCountry").attr("required", true);
                $("#GIIN").attr("required", true);
                $("#AlamatTIN").attr("required", true);
                ...
                $("#FATCA").data("kendoComboBox").value("");
                $("#FATCA").data("kendoComboBox").enable(false);
                $("#TIN").attr('readonly', true);
                $('#btnListTINIssuanceCountry').attr("disabled", true);
                $("#GIIN").attr('readonly', true);
                $("#AlamatTIN").attr('readonly', true);
        ...
        function setCmbFATCACRS() {
            if (data.FATCACRS == null) {
                return "";
            } else {
                return data.FATCACRS;
            }
        }

        $("#JabatanKantor").kendoComboBox({
            dataTextField: "text",
            dataValueField: "value",
            dataSource: [
                { text: "Staff", value: 1 },
                ...
                { text: "Senior Manager", value: 4 },
                { text: "General Manager", value: 5 },
                { text: "Director", value: 6 },
            ],
            filter: "contains",
            suggest: true,
            change: OnChangeJabatanKantor,
            value: setCmbJabatanKantor()
        });
        function OnChangeJabatanKantor() {
            if (this.value() && this.selectedIndex == -1) {
                var dt = this.dataSource._data[0];
                this.text('');
            }
        ...
        function setCmbJabatanKantor() {
            if (data.JabatanKantor == null) {
                return "";
            } else {
                return data.JabatanKantor;
            }
        }

        $("#SpouseParentOfficePosition").kendoComboBox({
            dataTextField: "text",
            dataValueField: "value",
            dataSource: [
                { text: "Staff", value: 1 },
            ...
            filter: "contains",
            suggest: true,
            change: OnChangeSpouseParentOfficePosition,
            value: setCmbSpouseParentOfficePosition()
        });
        function OnChangeSpouseParentOfficePosition() {
            if (this.value() && this.selectedIndex == -1) {
                var dt = this.dataSource._data[0];
                this.text('');
            }
        ...
        function setCmbSpouseParentOfficePosition() {
            if (data.SpouseParentOfficePosition == null) {
                return "";
            } else {
                return data.SpouseParentOfficePosition;
            }
        }

        $("#IncomeInformation").kendoComboBox({
            dataTextField: "text",
            dataValueField: "value",
            dataSource: [
                { text: "Has Income", value: 1 },
                { text: "No Income", value: 0 }
            ],
            filter: "contains",
            suggest: true,
            change: OnChangeIncomeInformation,
            value: setCmbIncomeInformation()
        });
        function OnChangeIncomeInformation() {
            if (this.value() && this.selectedIndex == -1) {
                var dt = this.dataSource._data[0];
                this.text('');
            }
        ...
        function setCmbIncomeInformation() {
            if (data.IncomeInformation == null) {
                return "";
            } else {
                return data.IncomeInformation;
            }
        }
        ...
        function onChangeStatusPerkawinan() {
            ...
            if ($("#StatusPerkawinan").val() == 2) {
                ...
                if (_GlobClientCode == "20") {
                    ...
                    $("#SpouseDateOfBirth").attr("required", true);
                    $("#SpouseParentIDNumber").attr("required", true);
                    $("#SpouseOccupation").attr("required", true);
                    $("#OtherSpouseOccupation").attr("required", false);
                    $("#SpouseParentCompanyName").attr("required", true);
                    $("#SpouseNatureOfBusiness").attr("required", true);
                    $("#SpouseParentOfficePosition").attr("required", true);
                    $("#SpouseParentCompanyAddress").attr("required", true);
                    $("#SpouseAnnualIncome").attr("required", true);
                    $("#SpouseParentSourceOfFund").attr("required", true);

                    $("#lblHeirRelationship2").show();
                    $("#lblHeir2").show();
                    $("#lblSpouseParentSourceOfFund").show();
                    $("#lblSpouseParentOfficePosition").show();
                    $("#lblSpouseParentCompanyAddress").show();
                    $("#lblSpouseParentCompanyName").show();
                    $("#lblSpouseParentIDNumber").show();
                    ...
                    $("#lblSpouseNationality").show();
                    $("#lblSpouseBirthPlace").show();
                }
            }
                ...
                $("#lblSpouse").hide();
                if (_GlobClientCode == "20") {
                    if ($("#Pekerjaan").val() == 1 || $("#Pekerjaan").val() == 2) {
                        $("#lblSpouse").show();
                        $("#SpouseName").attr("required", true);
                        $("#SpouseDateOfBirth").attr("required", true);
                        $("#SpouseParentIDNumber").attr("required", true);
        ...
        function onChangePekerjaan() {
            ...
            if ($('#Pekerjaan').val() == 3) {
                ...
                if (_GlobClientCode == "20") {
                    ...
                    $("#NamaKantor").attr("required", true);
                    $("#JabatanKantor").attr("required", true);
                    $("#TeleponKantor").attr("required", true);
                    $("#AlamatKantorInd").attr("required", true);

                    if ($("#KodeKotaKantorInd").val() == 0) {
                        $("#KodeKotaKantorInd").val("");
                    }
                    if ($("#KodePropinsiKantorInd").val() == 0) {
                        $("#KodePropinsiKantorInd").val("");
                    }
                    $("#KodeKotaKantorInd").attr("required", true);
                    $("#KodePropinsiKantorInd").attr("required", true);
                    $("#KodeCountryofKantor").attr("required", true);
                    $("#KodePosKantorInd").attr("required", true);
        ...
        function setCmbPekerjaan() {
            if (data.Pekerjaan == 3) {
                ...
                if (data.StatusPerkawinan == 2) {
                    $("#lblSpouseName").show();
                    $("#lblSpouseDateOfBirth").show();
                    $("#lblSpouseBirthPlace").show();
                    $("#lblSpouseParentIDNumber").show();
                    $("#lblSpouseOccupation").show();
                    $("#lblOtherSpouseOccupation").show();
                    $("#lblSpouseParentCompanyName").show();
                    $("#lblSpouseNatureOfBusiness").show();
                    $("#lblSpouseParentOfficePosition").show();
                    $("#lblSpouseParentCompanyAddress").show();
                    $("#lblSpouseIDNo").show();
                    $("#lblSpouseNationality").show();
                    $("#lblSpouseAnnualIncome").show();
                    $("#lblOtherTeleponRumah").show();
                    $("#lblOtherTeleponSelular").show();
                    $("#lblOtherFax").show();
                    $("#lblOtherEmail").show();
                    $("#lblSpouseParentSourceOfFund").show();
                    $("#lblHeir2").show();
        ...
        //combo box APUPPTOccupation
        $.ajax({
            url: window.location.origin + "/Radsoft/MasterValue/GetMasterValueCombo/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/APUPPTOCCUPATION",
            type: 'GET',
            contentType: "application/json;charset=utf-8",
            success: function (data) {
                $("#APUPPTOccupation").kendoComboBox({
                    dataValueField: "Code",
                    dataTextField: "DescOne",
                    filter: "contains",
                    suggest: true,
                    dataSource: data,
                    change: onChangeAPUPPTOccupation,
                    value: setCmbAPUPPTOccupation()
                });
            },
            error: function (data) {
                alertify.alert(data.responseText);
        ...
        function onChangeAPUPPTOccupation() {
        ...
        function setCmbAPUPPTOccupation() {
            if (data.APUPPTOccupation == null) {
                return "";
            } else {
                if (data.APUPPTOccupation == 0) {
                    return "";
                } else {
                    return data.APUPPTOccupation;
                }
            }
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#BeneficialIdentitasInd").kendoComboBox({
                    dataValueField: "Code",
                    dataTextField: "DescOne",
                    filter: "contains",
                    suggest: true,
                    // change: onChangeIdentitas,
                    dataSource: data,
                    value: BeneficialIdentitasInd()
                });
                $("#BeneficialIdentitasInd1").kendoComboBox({
                    dataValueField: "Code",
                    dataTextField: "DescOne",
                    filter: "contains",
                    suggest: true,
                    //change: onChangeIdentitas,
                    dataSource: data,
                    value: BeneficialIdentitasInd1()
                });
                $("#BeneficialIdentitasInd2").kendoComboBox({
                    dataValueField: "Code",
                    dataTextField: "DescOne",
                    filter: "contains",
                    suggest: true,
                    //change: onChangeIdentitas,
                    dataSource: data,
                    value: BeneficialIdentitasInd2()
                });
                $("#BeneficialIdentitasInd3").kendoComboBox({
                    dataValueField: "Code",
                    dataTextField: "DescOne",
                    filter: "contains",
                    suggest: true,
        ...
        function BeneficialIdentitasInd() {
            if (data.BeneficialIdentitasInd == null) {
                return "";
            } else {
                if (data.BeneficialIdentitasInd == 0) {
                    return "";
                } else {
                    return data.BeneficialIdentitasInd;
                }
            }
        }
        function BeneficialIdentitasInd1() {
            if (data.BeneficialIdentitasInd1 == null) {
                return "";
            } else {
                if (data.BeneficialIdentitasInd1 == 0) {
                    return "";
                } else {
                    return data.BeneficialIdentitasInd1;
                }
            }
        }
        function BeneficialIdentitasInd2() {
            if (data.BeneficialIdentitasInd2 == null) {
                return "";
            } else {
                if (data.BeneficialIdentitasInd2 == 0) {
                    return "";
                } else {
                    return data.BeneficialIdentitasInd2;
                }
            }
        }
        function BeneficialIdentitasInd3() {
            if (data.BeneficialIdentitasInd3 == null) {
                return "";
            } else {
                if (data.BeneficialIdentitasInd3 == 0) {
                    return "";
                } else {
                    return data.BeneficialIdentitasInd3;
                }
            }
        }
        ...
        function onChangeAssetOwner() {
            ...
            if ($("#AssetOwner").val() == 2) {
                ...
                if (_GlobClientCode == "20") {
                    $("#BeneficialName").attr("required", true);
                    $("#BeneficialAddress").attr("required", true);
                    $("#BeneficialIdentitasInd").attr("required", true);
                    $("#BeneficialIdentity").attr("required", true);
                    $("#BeneficialNPWP").attr("required", true);
                    $("#BeneficialRelation").attr("required", true);
                    $("#BeneficialWork").attr("required", false);
                    $("#BeneficialHomeNo").attr("required", false);
                    $("#BeneficialPhoneNumber").attr("required", false);
    ...
    function validateData() {
        ...
        if (_GlobClientCode == "20") {
            if ($("#KodeDomisiliPropinsi").val() == 0 || $("#KodeDomisiliPropinsi").val() == null) {
                $("#KodeDomisiliPropinsi").val("");
            } //Dari Bang Aziz
            if ($("#OtherPropinsiInd1").val() == 0 || $("#OtherPropinsiInd1").val() == null) {
                $("#OtherPropinsiInd1").val("");
            }
            if ($("#OtherNegaraInd1").val() == 0 || $("#OtherNegaraInd1").val() == null) {
                $("#OtherNegaraInd1").val("");
            }
            if ($("#Propinsi").val() == 0 || $("#Propinsi").val() == null) {
                $("#Propinsi").val("");
            }
            if ($("#CountryofCorrespondence").val() == 0 || $("#CountryofCorrespondence").val() == null) {
                $("#CountryofCorrespondence").val("");
            }
            if ($("#KodeKotaInd2").val() == 0 || $("#KodeKotaInd2").val() == null) {
                $("#KodeKotaInd2").val("");
            }
            if ($("#CountryofDomicile").val() == 0 || $("#CountryofDomicile").val() == null) {
                $("#CountryofDomicile").val("");
            }
            if ($("#KodeKotaKantorInd").val() == 0 || $("#KodeKotaKantorInd").val() == null) {
                $("#KodeKotaKantorInd").val("");
            }
            if ($("#KodePropinsiKantorInd").val() == 0 || $("#KodePropinsiKantorInd").val() == null) {
                $("#KodePropinsiKantorInd").val("");
            }
            if ($("#KodeCountryofKantor").val() == 0 || $("#KodeCountryofKantor").val() == null) {
                $("#KodeCountryofKantor").val("");
            }
            if ($("#Negara").val() == 0 || $("#Negara").val() == null) {
                $("#Negara").val("");
            }
            if ($("#InvestorType").data("kendoComboBox").value() == 2) {
                if ($("#NamaDepanIns2").val().length > 0) {
                    $("#IdentityTypeOfficer2").attr("required", true);
                    $("#NoIdentitasOfficer2").attr("required", true);
    ...
    function clearDataInd() {
        ...
        $("#BeneficialIdentitasInd").val("");
        $("#BeneficialIdentitasInd1").val("");
        $("#BeneficialIdentitasInd2").val("");
        $("#BeneficialIdentitasInd3").val("");
    ...
    function clearData() {
        ...
        $("#AlamatTIN").val("");
        $("#FATCACRSDesc").val("");
        $("#IncomeInformation").val("");
        $("#IncomeInformationDesc").val("");
        $("#SpouseParentSourceOfFund").val("");
        $("#Heir").val("");
        $("#HeirRelationship2").val("");
        $("#SpouseParentIDNumber").val("");
        $("#SpouseParentCompanyName").val("");
        $("#SpouseParentOfficePosition").val("");
        $("#SpouseParentCompanyAddress").val("");
        $("#FATCA").val("");
        $("#FATCADesc").val("");
        $("#TIN").val("");
        $("#TINIssuanceCountry").val("");
        ...
        $("#BeneficialAddress1").val("");
        $("#BeneficialAddress2").val("");
        $("#BeneficialAddress3").val("");

        $("#BeneficialIdentity1").val("");
        $("#BeneficialIdentity2").val("");
        $("#BeneficialIdentity3").val("");

        $("#BeneficialRelation1").val("");
        $("#BeneficialRelation2").val("");
        $("#BeneficialRelation3").val("");
    ...
    function initGrid() {
        ...
        _paramDateFrom = kendo.toString(new Date(2000, 1, 1), "MM-dd-yyyy");
        _paramDateTo = kendo.toString(new Date(9998, 12, 31), "MM-dd-yyyy");
        ...
        if (_GlobClientCode == "10") {
            $("#gridFundClientPending").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "TeleponSelular", title: "Telepon Selular", width: 150 },
                    { field: "Email", title: "Email", width: 150 },
                    { field: "KYCRiskProfileDesc", hidden: true, title: "KYC Risk Profile", width: 150 },
                    { field: "CapitalPaidIn", title: "CapitalPaidIn", width: 200, format: "{0:n4}", attributes: { style: "text-align:right;" } },
                    { field: "BitIsSuspend", title: "Is Suspend", width: 100, template: "#= BitIsSuspend ? 'Yes' : 'No' #" },
                    { field: "EntryUsersID", title: "Entry ID", width: 200 },
                    { field: "EntryTime", title: "E.Time", format: "{0:dd/MMM/yyyy HH:mm:ss}", width: 180 },
    ...
    $("#BtnAdd").click(function () {
        ...
        var _BeneficialIdentitasInd, _BeneficialIdentitasInd1, _BeneficialIdentitasInd2, _BeneficialIdentitasInd3;

        if ($('#BeneficialIdentitasInd').val() == "")
            _BeneficialIdentitasInd = 0
        else
            _BeneficialIdentitasInd = $('#BeneficialIdentitasInd').val();

        if ($('#BeneficialIdentitasInd1').val() == "")
            _BeneficialIdentitasInd1 = 0
        else
            _BeneficialIdentitasInd1 = $('#BeneficialIdentitasInd1').val();

        if ($('#BeneficialIdentitasInd2').val() == "")
            _BeneficialIdentitasInd2 = 0
        else
            _BeneficialIdentitasInd2 = $('#BeneficialIdentitasInd2').val();

        if ($('#BeneficialIdentitasInd3').val() == "")
            _BeneficialIdentitasInd3 = 0
        else
            _BeneficialIdentitasInd3 = $('#BeneficialIdentitasInd3').val();
            ...
            alertify.confirm("Are you sure want to Add data?", function (e) {
                if (e) {
                    ...
                    var FundClient = {
                        ...
                        APUPPTOccupation: $('#APUPPTOccupation').val(),
                        ...
                        FATCACRS: $('#FATCACRS').val(), 
                        IncomeInformation: $('#IncomeInformation').val(), 
                        AlamatTIN: $('#AlamatTIN').val(), 

                        SpouseParentSourceOfFund: $('#SpouseParentSourceOfFund').val(),
                        Heir: $('#Heir').val(),
                        HeirRelationship: $('#HeirRelationship').val(),
                        SpouseParentIDNumber: $('#SpouseParentIDNumber').val(),
                        SpouseParentCompanyName: $('#SpouseParentCompanyName').val(),
                        SpouseParentOfficePosition: $('#SpouseParentOfficePosition').val(),
                        SpouseParentCompanyAddress: $('#SpouseParentCompanyAddress').val(),
                        ...
                        BeneficialName1: $('#BeneficialName1').val(),
                        BeneficialName2: $('#BeneficialName2').val(),
                        BeneficialName3: $('#BeneficialName3').val(),

                        BeneficialAddress1: $('#BeneficialAddress1').val(),
                        BeneficialAddress2: $('#BeneficialAddress2').val(),
                        BeneficialAddress3: $('#BeneficialAddress3').val(),

                        BeneficialIdentity1: $('#BeneficialIdentity1').val(),
                        BeneficialIdentity2: $('#BeneficialIdentity2').val(),
                        BeneficialIdentity3: $('#BeneficialIdentity3').val(),

                        BeneficialRelation1: $('#BeneficialRelation1').val(),
                        BeneficialRelation2: $('#BeneficialRelation2').val(),
                        BeneficialRelation3: $('#BeneficialRelation3').val(),

                        BeneficialNPWP1: $('#BeneficialNPWP1').val(),
                        BeneficialNPWP2: $('#BeneficialNPWP2').val(),
                        BeneficialNPWP3: $('#BeneficialNPWP3').val(),


                        BeneficialIdentitasInd: _BeneficialIdentitasInd,
                        BeneficialIdentitasInd1: _BeneficialIdentitasInd1,
                        BeneficialIdentitasInd2: _BeneficialIdentitasInd2,
                        BeneficialIdentitasInd3: _BeneficialIdentitasInd3
                    ...
                    success: function (data) {
                        if ($("#LastUpdate").val() == kendo.toString(kendo.parseDate(data), 'dd/MMM/yyyy HH:mm:ss')) {
                            ...
                            if ($("#ID").val() == null || $("#ID").val() == "" || $("#ID").val() == "000") {
                                // KERJAAN
                                InsertKYCProfile($("#FundClientPK").val(), $("#HistoryPK").val());
    ...
    $("#FileImportPath").change(function () {
        ...
        if (files.length > 0) {
            ...
            $.ajax({
                url: window.location.origin + "/Radsoft/Upload/UploadDataFourParams/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + "FundClientDocument_Import/" + $('#FundClientPK').val(),
                type: 'POST',
                data: data,
                contentType: false,
                processData: false,
    ...
    $("#btnClearListOfficeCity").click(function () {
        $("#KodeKotaKantorInd").val("");
        $("#KodeKotaKantorIndDesc").val("");
    });
    ...
    function getDataQuestionnaire(_url) {
        return new kendo.data.DataSource(
            {
                transport:
                {
                ...
                schema: {
                    model: {
                        fields: {
                            RiskQuestionnairePK: { type: "number" },
                            Question: { type: "string", editable: false },
                            //Answer: { defaultValue: { RiskQuestionnaireAnswerPK: 36, Answer: '1 – 2 tahun' }}
                        }
                    }
                }
            });
    ...
    var _new = {
        'RiskQuestionnaireAnswerPK': 0,
        'Answer': 'Click here to choose answer'
    };
    _RiskAnswer.push(_new);

    //RiskQuesionnaireAnswer
    $.ajax({
        url: window.location.origin + "/Radsoft/RiskQuestionnaireAnswer/GetData/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/2",
        type: 'GET',
        contentType: 'application/json;charset=utf-8',
        async: false,
        success: function (data) {
            ...
            for (i = 0; i < data.length; i++) {
                tes = {
                    'RiskQuestionnaireAnswerPK': data[i].RiskQuestionnaireAnswerPK,
                    'Answer': data[i].Answer
                };
                _RiskAnswer.push(tes);
            }
        },
        error: function (data) {
            console.log('GetOfficeCombo, ' + data.responseText);
        }
    });


    function RiskQuesionnaireAnswer(container, options) {

        _RiskQuestionnairePK = options.model.RiskQuestionnairePK;

        $('<input required name="' + options.field + '"/>')
            .appendTo(container)
            .kendoComboBox({
                dataTextField: "Answer",
                dataValueField: "RiskQuestionnaireAnswerPK",
                dataSource: {
                    transport:
                    {
                        read:
                        {
                            url: window.location.origin + "/Radsoft/RiskQuestionnaireAnswer/GetAnswerRiskQuestionnaire/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _RiskQuestionnairePK,
                            dataType: "json"
                        }
                    },
                },
                cascadeFrom: "RiskQuestionnaireAnswerPK",
                //valueTemplate: "#:Answer#"
            });

    }

    function FGetAnswer(RiskQuestionnaireAnswerPK) {
        for (var i = 0; i < _RiskAnswer.length; i++) {
            if (_RiskAnswer[i].RiskQuestionnaireAnswerPK == RiskQuestionnaireAnswerPK) {
                return _RiskAnswer[i].Answer;
            }
    ...
    function initQuestionnaire() {
        ...
        var _InvestorType;
        if ($("#InvestorType").val() == undefined || $("#InvestorType").val() == "")
            _InvestorType = 0;
        else
            _InvestorType = $("#InvestorType").val();

        var _FundClientPK;
        if ($("#FundClientPK").val() == undefined || $("#FundClientPK").val() == "")
            _FundClientPK = 0;
        else
            _FundClientPK = $("#FundClientPK").val();

        setTotalScoreRiskQuesionnaire();

        $("#gridFundClientRiskQuestionnaire").empty();
        var FundClientQuestionnaireURL = window.location.origin + "/Radsoft/RiskQuestionnaire/GetListQuesionnaire/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _InvestorType + "/" + _FundClientPK,
            dataSourceApproved = getDataQuestionnaire(FundClientQuestionnaireURL);

        $("#gridFundClientRiskQuestionnaire").kendoGrid({
            dataSource: dataSourceApproved,
            height: 800,
            scrollable: {
                virtual: false
            ...
            editable: true,
            dataBound: function () {
                var grid = $('#gridFundClientRiskQuestionnaire').data('kendoGrid');
                $(grid.tbody).on('change', 'td', function (e) {
                    ...
                    $('#gridFundClientRiskQuestionnaire').find('tr[data-uid="' + uid + '"] td:eq(' + colIdx + ')').css('background-color', 'lightblue');
            ...
            columns: [
                ...
                { field: "RiskQuestionnairePK", title: "RiskQuestionnairePK", hidden: true, filterable: false, width: 80 },
                { field: "No", title: "No", filterable: false, width: 50, attributes: { style: "text-align:center;" } },
                { field: "Question", title: "Question", width: 330 },
                {
                    field: "RiskQuestionnaireAnswerPK", title: "Answer", width: 330, editor: RiskQuesionnaireAnswer, attributes: { style: "font-weight: bold;" },
                    template: function (dataItem) {
                        return kendo.htmlEncode(FGetAnswer(dataItem.RiskQuestionnaireAnswerPK));
                    }
                }
            ]
        });
    ...
    $("#btnUpdateAnswer").click(function () {
        alertify.confirm("Are you sure want to update answer ?", function (e) {
            if (e) {
                var _FundClientPK = 0;
                _FundClientPK = $('#FundClientPK').val();

                var _Validation = [];
                var gridDataArray = $('#gridFundClientRiskQuestionnaire').data('kendoGrid')._data;
                for (var index = 0; index < gridDataArray.length; index++) {

                    var _m = {
                        RiskQuestionnairePK: gridDataArray[index]["RiskQuestionnairePK"],
                        RiskQuestionnaireAnswerPK: gridDataArray[index]["RiskQuestionnaireAnswerPK"],
                ...
                $.ajax({
                    url: window.location.origin + "/Radsoft/RiskQuestionnaireAnswer/InsertFromFundClient/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id"),
                    type: 'POST',
                    async: false,
                    ...
                    success: function (data) {
                        ...
                        alertify.alert("Answer updated").moveTo((screen.width / 4), (screen.height / 3));
                        setTotalScoreRiskQuesionnaire();
                        initQuestionnaire();
                    },
                    error: function (data) {
    ...
    function setTotalScoreRiskQuesionnaire() {

        var _FCPK;
        if ($("#FundClientPK").val() == undefined || $("#FundClientPK").val() == "")
            _FCPK = 0;
        else
            _FCPK = $("#FundClientPK").val();

        $.ajax({
            url: window.location.origin + "/Radsoft/FundClient/SelectTotalScoreRiskQuestionnaire/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _FCPK,
            type: 'GET',
            async: false,
            contentType: "application/json;charset=utf-8",
            success: function (data) {

                $("#TotalScoreRiskQuesionnaire").val(data);
    ...
    function InsertKYCProfile(_fundClientPK, _historyPK) {

        $.ajax({
            url: window.location.origin + "/Radsoft/HighRiskMonitoring/InsertHighRiskMonitoringCustomClient20/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _fundClientPK + "/" + _historyPK,
            type: 'GET',
            contentType: "application/json;charset=utf-8",
            success: function (data) {
                if (data != "") {
