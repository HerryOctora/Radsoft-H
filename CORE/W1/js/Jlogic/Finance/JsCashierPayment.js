$(document).ready(function () {
    document.title = 'FORM CASHIER PAYMENT';
    var win;
    var tabindex;
    var winOldData;
    ...
    function initWindow() {
        ...
        win = $("#WinCashierPayment").kendoWindow({
            height: 1500,
        ...
        WinParamName = $("#WinParamName").kendoWindow({
            height: 250,
            title: "PRINT VOUCHER",
            visible: false,
            width: 600,
    ...
    var GlobValidator = $("#WinCashierPayment").kendoValidator().data("kendoValidator");
    ...
    function showDetails(e) {
        ...
        if (e == null) {
            ...
            if (tabindex == 0 || tabindex == undefined) {
                grid = $("#gridCashierPaymentApproved").data("kendoGrid");

            }
            if (tabindex == 1) {

                grid = $("#gridCashierPaymentPending").data("kendoGrid");
            }
            if (tabindex == 2) {

                grid = $("#gridCashierPaymentHistory").data("kendoGrid");
            }
            ...
            $("#CreditAccountPK").val(dataItemX.CreditAccountPK);
        ...
        $.ajax({
            ...
            contentType: "application/json;charset=utf-8",
            success: function (data) {
                $("#CreditCashRefPK").kendoComboBox({
                    dataValueField: "CashRefPK",
                    dataTextField: "ID",
                    dataSource: data,
                    change: OnChangeCreditCashRefPK,
                    filter: "contains",
                    suggest: true,
                    value: setCmbCreditCashRefPK()
                });
            },
            error: function (data) {
                alertify.alert(data.responseText);
        ...
        function setCmbCreditCashRefPK() {
            if (e == null) {
                return "";
            } else {
                if (dataItemX.CreditCashRefPK == 0) {
                    return "";
                } else {
                    return dataItemX.CreditCashRefPK;
                }
            }
        }
        function OnChangeCreditCashRefPK() {
            if (this.value() && this.selectedIndex == -1) {
                var dt = this.dataSource._data[0];
                this.text('');
            }
                ...
                $.ajax({
                    url: window.location.origin + "/Radsoft/CashRef/GetCashRefByPK/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + $("#CreditCashRefPK").data("kendoComboBox").value(),
                    type: 'GET',
                    contentType: "application/json;charset=utf-8",
                    success: function (data) {
        ...
        $.ajax({
            ...
            contentType: "application/json;charset=utf-8",
            success: function (data) {
                $("#DebitAccountPK").kendoComboBox({
                    dataValueField: "AccountPK",
                    dataTextField: "ID",
                    filter: "contains",
                    suggest: true,
                    dataSource: data,
                    change: OnChangeDebitAccountPK,
                    value: setCmbDebitAccountPK()
                });
            },
            error: function (data) {
                alertify.alert(data.responseText);
        ...
        function setCmbDebitAccountPK() {
            if (e == null) {
                return "";
            } else {
                if (dataItemX.DebitAccountPK == 0) {
                    return "";
                } else {
                    return dataItemX.DebitAccountPK;
                }
            }
        }
        function OnChangeDebitAccountPK() {
            if (this.value() && this.selectedIndex == -1) {
                var dt = this.dataSource._data[0];
                this.text('');
            } else {
                if ($("#DebitAccountPK").val() == "") {
                    ...
                    $.ajax({
                        url: window.location.origin + "/Radsoft/Account/GetAccountByPK/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + $("#DebitAccountPK").data("kendoComboBox").value(),
                        type: 'GET',
                        contentType: "application/json;charset=utf-8",
                        success: function (data) {
    ...
    $("#BtnNewVoucher").click(function () {
        ...
        $("#BaseCredit").data("kendoNumericTextBox").value("");
        $("#Description").val("");
        $("#OfficePK").data("kendoComboBox").value(1);
        $("#DepartmentPK").data("kendoComboBox").value("");
        $("#AgentPK").data("kendoComboBox").value("");
        $("#CounterpartPK").data("kendoComboBox").value("");
        $("#ConsigneePK").data("kendoComboBox").value("");
    ...
    function onDataBound() {
        var grid = $("#gridCashierPaymentApproved").data("kendoGrid");
    ...
    function initGrid() {
        if (_GlobClientCode == "01") {
            $("#gridCashierPaymentApproved").empty();
            if ($("#DateFrom").val() == null || $("#DateFrom").val() == "" || $("#DateTo").val() == null || $("#DateTo").val() == "") {
                alertify.alert("Please Fill Date");
            }

            else {
                var CashierApprovedURL = window.location.origin + "/Radsoft/Cashier/GetDataFromTo/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + 2 + "/" + "CP" + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy"),
            ...
            //  dataSourceApproved = getDataSource(CashierApprovedURL);
            var grid = $("#gridCashierPaymentApproved").kendoGrid({
                ...
                columns: [
                    ...
                    //},
                        ...
                        { field: "DebitAccountID", title: "PAYMENT FOR", width: 150 },
                        { field: "DebitAccountName", title: "PAYMENT FOR", width: 150 },
                        { field: "DocRef", title: "DocRef", width: 100 },
                        { field: "Description", title: "Description", width: 200 },
                        { field: "BaseCredit", title: "Amount IDR", width: 200, format: "{0:n" + GlobDecimalPlaces + "}", attributes: { style: "text-align:right;" } },
            ...
            var grid = $("#gridCashierPaymentApproved").kendoGrid({
                ...
                columns: [
                    ...
                    //},
                    {
                        ...
                        { field: "BaseCredit", title: "Amount IDR", width: 200, format: "{0:n2}", attributes: { style: "text-align:right;" } },
                        { field: "DocRef", title: "DocRef", width: 100 },
                        ...
                        { field: "BaseDebit", title: "Receipt Amount (Debit)", width: 300, format: "{0:n2}", hidden: true },
                        { field: "PeriodPK", title: "PeriodPK", hidden: true, width: 120, hidden: true },
                        { field: "PeriodID", title: "Period ID", width: 200, hidden: true },
                        { field: "DebitCredit", title: "Debit Credit", hidden: true, width: 200, hidden: true },
                        { field: "EntryUsersID", title: "Entry ID", width: 200 },
        ...
        if (filterlogic != undefined || filterField != undefined || filterOperator != undefined || filtervalue != undefined) {
            ...
            var gridTesFilter = $("#gridCashierPaymentApproved").data("kendoGrid");
        ...
        var loadedTabs = [0];
        $("#TabCashierPayment").kendoTabStrip({
            animation: {
                open: {
                    effects: "fadeIn"
                }
    ...
    function SelectDeselectData(_a, _b) {
        $.ajax({
            url: window.location.origin + "/Radsoft/Host/SelectDeselectDataCashier/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/Cashier/" + _a + "/" + _b + "/CP",
            type: 'GET',
            contentType: "application/json;charset=utf-8",
            success: function (data) {
                var _msg;
    ...
    function SelectDeselectAllData(_a, _b) {
        $.ajax({
            url: window.location.origin + "/Radsoft/Host/SelectDeselectAllDataByDateCashier/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/Cashier/" + _a + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP",
            type: 'GET',
            contentType: "application/json;charset=utf-8",
            success: function (data) {
    ...
    function RecalGridPending() {
        if (_GlobClientCode == "01") {
            $("#gridCashierPaymentPending").empty();
            if ($("#DateFrom").val() == null || $("#DateFrom").val() == "" || $("#DateTo").val() == null || $("#DateTo").val() == "") {
                alertify.alert("Please Fill Date");
            }

            else {
                var CashierPendingURL = window.location.origin + "/Radsoft/Cashier/GetDataFromTo/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + 1 + "/" + "CP" + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy"),
                dataSourcePending = getDataSource(CashierPendingURL);
            }
            var grid = $("#gridCashierPaymentPending").kendoGrid({
        ...
        if (filterlogic != undefined || filterField != undefined || filterOperator != undefined || filtervalue != undefined) {
            ...
            var gridTesFilter = $("#gridCashierPaymentPending").data("kendoGrid");
        ...
        function selectDataPending(e) {
            ...
            var grid = $("#gridCashierPaymentPending").data("kendoGrid");
            var dataItemX = grid.dataItem($(e.currentTarget).closest("tr"));
            var _cashierPK = dataItemX.CashierPK;
            var _checked = this.checked;
            SelectDeselectData(_checked, _cashierPK);
    ...
    function RecalGridHistory() {
        if (_GlobClientCode == "01") {
            $("#gridCashierPaymentHistory").empty();
            if ($("#DateFrom").val() == null || $("#DateFrom").val() == "" || $("#DateTo").val() == null || $("#DateTo").val() == "") {
                alertify.alert("Please Fill Date");
            }

            else {
                var CashierHistoryURL = window.location.origin + "/Radsoft/Cashier/GetDataFromTo/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + 9 + "/" + "CP" + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy"),
                dataSourceHistory = getDataSource(CashierHistoryURL);
            }
            $("#gridCashierPaymentHistory").kendoGrid({
                ...
                columns: [
                        ...
                        { field: "Status", title: "Status", filterable: false, hidden: true, width: 120 },
                        { field: "StatusDesc", title: "StatusDesc", width: 150 },
                        { field: "HistoryPK", title: "HisNo.", filterable: false, hidden: true, width: 120 },
                        { field: "Posted", title: "Posted", width: 100, template: "#= Posted ? 'Yes' : 'No' #" },
                        { field: "Revised", title: "Revised", width: 100, template: "#= Revised ? 'Yes' : 'No' #" },
    ...
    function gridHistoryDataBound() {
        var grid = $("#gridCashierPaymentHistory").data("kendoGrid");
        var data = grid.dataSource.data();
        $.each(data, function (i, row) {
                ...
                if (a) {
                    ...
                    if (pos == true) {
                        ...
                        if (_ref != "") {
                            ...
                            $.ajax({
                                url: window.location.origin + "/Radsoft/Cashier/Action/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + "CashierPayment_Posting",
                                type: 'POST',
                ...
                if (a) {
                    ...
                    if (_dataItemX.Revised == true) {
                        ...
                        if (_ref != "") {
                            ...
                            $.ajax({
                                url: window.location.origin + "/Radsoft/Cashier/Action/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + "CashierPayment_Revise",
                                type: 'POST',
    ...
    $("#BtnVoucher").click(function () {
        ...
        if ($('#CashierPK').val() == null || $('#CashierPK').val() == "") {
            alertify.alert("Download Payment Voucher Cancel,Please Add Cashier First");
        }
        else {
            
            alertify.confirm("Are you sure want to Download Payment Voucher ?", function (e) {
                ...
                if (e) {
                    ...
                    $.ajax({
                        url: window.location.origin + "/Radsoft/Cashier/PaymentVoucher/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id"),
                        type: 'POST',
        ...
        if (val == 1) {
            alertify.confirm("Are you sure want to Generate Report ?", function (e) {
                if (e) {
                    ...
                    $.ajax({
                        url: window.location.origin + "/Radsoft/Reports/PrintVoucherPayment/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + $('#PeriodPK').val() + "/" + $('#CashierID').val(),
                        type: 'POST',
                        contentType: "application/json;charset=utf-8",
                        data: JSON.stringify(CashierVoucher),
                        success: function (data) {
                            var newwindow = window.open(data, '_blank');
    ...
    $("#BtnPosting").click(function () {
        var _urlValidate = "";
        //if (_GlobClientCode == "01") {
        //    _urlValidate = window.location.origin + "/Radsoft/Cashier/ValidateCheckPostingCashierByReference/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP" + "/" + $("#CashierPK").val();
        //} else {
        //    _urlValidate = window.location.origin + "/Radsoft/Cashier/ValidateCheckPostingCashierById/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP" + "/" + $("#CashierID").val();
        //}
    ...
    $("#BtnRevise").click(function () {
        ...
        alertify.confirm("Are you sure want to Revise ?", function (a) {
            if (a) {
                ...
                $.ajax({
                    url: window.location.origin + "/Radsoft/Cashier/Cashier_ValidateOtherTransaction/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + $('#CashierPK').val() + "/CP",
                    type: 'GET',
                    contentType: "application/json;charset=utf-8",
                    success: function (data) {
                        if (data == "") {
    ...
    $("#BtnGenerateNewReference").click(function () {
        $.ajax({
            url: window.location.origin + "/Radsoft/CashierReference/CashierReference_GenerateNewReference/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + $("#Type").data("kendoComboBox").value() + "/" + $("#PeriodPK").data("kendoComboBox").value(),
            type: 'GET',
            contentType: "application/json;charset=utf-8",
            success: function (data) {
                $("#Reference").val(data);
                    ...
                    success: function (data) {
                        ...
                        if (_GlobClientCode == "01") {
                            if ($("#DebitAccountPK").val() == "") {
                                ...
                                $.ajax({
                                    url: window.location.origin + "/Radsoft/Account/GetAccountByPK/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + $("#DebitAccountPK").val(),
                                    type: 'GET',
                                    contentType: "application/json;charset=utf-8",
                                    success: function (data) {
                                        if (data.Type > 2 && ($("#DepartmentPK").val() == null || $("#DepartmentPK").val() == '')) {
                                            ...
                                            if ($("#ValueDate").data("kendoDatePicker").value().getMonth().toString() == GlobOpenMonth - 1 && $("#PeriodPK").data("kendoComboBox").value() == GlobOpenPeriod) {
                                                ...
                                                if (val == 1) {
                                                    ...
                                                    alertify.confirm("Are you sure want to Add Cashier Payment ( " + $("#DebitCredit").data("kendoComboBox").text() + " ) ?", function (e) {
                                                        if (e) {
                                                                        ...
                                                                        if (e) {
                                                                            ...
                                                                            $.ajax({
                                                                                ...
                                                                                success: function (data) {
                                                                                    ...
                                                                                    $.ajax({
                                                                                        url: window.location.origin + "/Radsoft/Cashier/GetBankBalanceByReference/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _ref + "/CP",
                                                                                        type: 'GET',
                                                                                        contentType: "application/json;charset=utf-8",
                                                                                        success: function (data) {
                                                                                            var _potAmount = 0;
                                                                                            ...
                                                                                            var _debitAccountPK = $('#DebitAccountPK').val();
                                                                                            if ($('#DebitCredit').val() == 'C') {
                                                                                            ...
                                                                                            if ((parseFloat(data + _potAmount)) > 0) {
                                                                                                $.ajax({
                                                                                                    url: window.location.origin + "/Radsoft/Cashier/GetSumPercentAmountByReferenceByAccount/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _ref + "/" + _debitAccountPK + "/" + _percentAmount + "/CP",
                                                                                                    type: 'GET',
                                                                                                    contentType: "application/json;charset=utf-8",
                                                                                                    success: function (data) {
                                                                                                        if ((data) <= 100) {
                                                                                                            ...
                                                                                                            $.ajax({
                                                                                                                url: window.location.origin + "/Radsoft/Cashier/Action/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + "CashierPayment_I",
                                                                                                                type: 'POST',
                                                                                                                data: JSON.stringify(Cashier),
                                                                                                                contentType: "application/json;charset=utf-8",
                                                                                                                success: function (data) {
                                                                                                                    ...
                                                                                                                    $("#DebitCredit").data("kendoComboBox").value('D');
                                                                                                                    $("#DebitCredit").data("kendoComboBox").text('Debit');
                                                                                                                    refresh();
                                                                                                                    clearDataWhenAdd();
                                                                                                                    $("#detailRef").show();
                                                                                                                    $("#gridReferenceDetail").empty();
                                                                                                ...
                                                                                                alertify.alert("Check Debit Credit Position. Bank can't be Minus");
                                                                                            }
                                                                            ...
                                                                            alertify.alert("Add Cashier Payment Cancel,Please Choose old Reference");
                                                                        }
                                                                    });
                                                                }, 1000);
                                                            }
                                                            //Cek Reference bila manual, Cek ValueDate , Cek CashRef                      
                                                                ...
                                                                $.ajax({
                                                                    url: window.location.origin + "/Radsoft/Cashier/AddCashierValidate/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#ValueDate").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + $("#CreditCashRefPK").val() + "/" + $("#Reference").val().split('/').join('-') + "/CP",
                                                                    type: 'GET',
                                                                    contentType: "application/json;charset=utf-8",
                                                                    success: function (data) {
                                                                        if (data == 1) {
                                                    ...
                                                    alertify.confirm("Are you sure want to Add Cashier Payment ( " + $("#DebitCredit").data("kendoComboBox").text() + " ) ?", function (e) {
                                                        if (e) {
                                                                    ...
                                                                    alertify.confirm("Are you sure want to Generate New CashierID ?", function (e) {
                                                                        if (e) {
                                                                            ...
                                                                            if (_GlobClientCode == "04") {
                                                                                _urlRef = "/Radsoft/Cashier/Cashier_GenerateNewCashierID/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + $("#Type").data("kendoComboBox").value() + "/" + $("#PeriodPK").data("kendoComboBox").value() + "/" + kendo.toString($("#ValueDate").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + $("#CreditCashRefPK").val() + "/" + "CashierCashierID_GenerateNewCashierID";
                                                                            }
                                                                            else {
                                                                            ...
                                                                            $.ajax({
                                                                                ...
                                                                                success: function (data) {
                                                                                    ...
                                                                                    $.ajax({
                                                                                        url: window.location.origin + "/Radsoft/Cashier/GetBankBalanceByCashierID/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _ref + "/CP/" + $("#PeriodPK").data("kendoComboBox").value(),
                                                                                        type: 'GET',
                                                                                        contentType: "application/json;charset=utf-8",
                                                                                        success: function (data) {
                                                                                            var _potAmount = 0;
                                                                                            ...
                                                                                            if ((parseFloat(data + _potAmount)) > 0) {
                                                                                                $.ajax({
                                                                                                    url: window.location.origin + "/Radsoft/Cashier/GetSumPercentAmountByCashierIDByAccount/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _ref + "/" + _debitAccountPK + "/" + _percentAmount + "/CP/" + $("#PeriodPK").data("kendoComboBox").value(),
                                                                                                    type: 'GET',
                                                                                                    contentType: "application/json;charset=utf-8",
                                                                                                    success: function (data) {
                                                                                                        if ((data) <= 100) {
                                                                            ...
                                                                            alertify.alert("Add Cashier Payment Cancel,Please Choose old CashierID");
                                                                        }
                                                                    });
                                                                }, 1000);
                                                            }
                                                            //Cek CashierID bila manual, Cek ValueDate , Cek CashRef                      
                                                                ...
                                                                $.ajax({
                                                                    url: window.location.origin + "/Radsoft/Cashier/AddCashierValidate/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#ValueDate").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + $("#CreditCashRefPK").val() + "/" + $("#CashierID").val() + "/CP",
                                                                    type: 'GET',
                                                                    contentType: "application/json;charset=utf-8",
                                                                    success: function (data) {
                                                                        if (data == 1) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    if ($("#LastUpdate").val() == kendo.toString(kendo.parseDate(data), 'dd/MMM/yyyy HH:mm:ss')) {
                                                        ...
                                                        $.ajax({
                                                            url: window.location.origin + "/Radsoft/Cashier/Action/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + "CashierPayment_U",
                                                            type: 'POST',
                                                            data: JSON.stringify(Cashier),
                                                            contentType: "application/json;charset=utf-8",
                                                            success: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if ($("#LastUpdate").val() == kendo.toString(kendo.parseDate(data), 'dd/MMM/yyyy HH:mm:ss')) {
                            ...
                            $.ajax({
                                url: window.location.origin + "/Radsoft/Cashier/Action/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + "CashierPayment_A",
                                type: 'POST',
                                data: JSON.stringify(Cashier),
                                contentType: "application/json;charset=utf-8",
                                success: function (data) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        if ($("#LastUpdate").val() == kendo.toString(kendo.parseDate(data), 'dd/MMM/yyyy HH:mm:ss')) {
                                            ...
                                            $.ajax({
                                                url: window.location.origin + "/Radsoft/Cashier/Action/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + "CashierPayment_V",
                                                type: 'POST',
                                                data: JSON.stringify(Cashier),
                                                contentType: "application/json;charset=utf-8",
                                                success: function (data) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        if ($("#LastUpdate").val() == kendo.toString(kendo.parseDate(data), 'dd/MMM/yyyy HH:mm:ss')) {
                                            ...
                                            $.ajax({
                                                url: window.location.origin + "/Radsoft/Cashier/Action/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + "CashierPayment_R",
                                                type: 'POST',
                                                data: JSON.stringify(Cashier),
                                                contentType: "application/json;charset=utf-8",
                                                success: function (data) {
    ...
    function getDataSourceCashierIDDetail() {
        ...
        var _urlRef = "";
        if (_GlobClientCode == "04") {
            _urlRef = "/Radsoft/CustomClient04/GetCashierIDDetail/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _status + "/" + $('#CashierID').val() + "/" + $("#PeriodPK").val() + "/CP";
        } else {
            _urlRef = "/Radsoft/Cashier/GetCashierIDDetail/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + $('#CashierID').val() + "/" + $("#PeriodPK").val() + "/CP";
        }
        return new kendo.data.DataSource(
                                  ...
                                  read:
                                      {
                                          ...
                                          url: window.location.origin + "/Radsoft/Cashier/CashierIDSelectFromCashierByType/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/CP" + "/"  + $("#PeriodPK").data("kendoComboBox").value(),
                                          dataType: "json"
                                      }
                              },
                      batch: true,
    ...
    function GetCashierCashierID() {
        ...
        //CashierID
        $.ajax({
            url: window.location.origin + "/Radsoft/Cashier/GetCashierIDComboByCashierType/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#ValueDateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#ValueDateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/OUT",
            type: 'GET',
            contentType: "application/json;charset=utf-8",
            success: function (data) {
    ...
    function getDataSourceReferenceDetail() {
        ...
        var _urlRef = "";
        if (_GlobClientCode == "04") {
            _urlRef = "/Radsoft/CustomClient04/GetReferenceDetail/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _status + "/" + $('#Reference').val() + "/CP";
        } else {
            _urlRef = "/Radsoft/Cashier/GetReferenceDetail/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + _status + "/" + $('#Reference').val() + "/CP";
        }
        return new kendo.data.DataSource(
                                  ...
                                  read:
                                      {
                                          ...
                                          url: window.location.origin + "/Radsoft/Cashier/ReferenceSelectFromCashierByType/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/CP" + "/" + kendo.toString($("#ValueDate").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + $("#PeriodPK").data("kendoComboBox").value(),
                                          dataType: "json"
                                      }
                              },
                      batch: true,
    ...
    function GetCashierReference() {
        ...
        //Reference
        $.ajax({
            url: window.location.origin + "/Radsoft/Cashier/GetReferenceComboByCashierType/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#ValueDateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#ValueDateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/OUT",
            type: 'GET',
            contentType: "application/json;charset=utf-8",
            success: function (data) {
    ...
    $("#BtnApproveBySelected").click(function (e) {
        ...
        alertify.confirm("Are you sure want to Approve by Selected Data ?", function (e) {
            if (e) {
                ...
                $.ajax({
                    url: window.location.origin + "/Radsoft/Cashier/ApproveBySelectedData/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP" ,
                    type: 'POST',
    ...
    $("#BtnRejectBySelected").click(function (e) {
        ...
        alertify.confirm("Are you sure want to Reject by Selected Data ?", function (e) {
            if (e) {
                ...
                $.ajax({
                    url: window.location.origin + "/Radsoft/Cashier/RejectBySelectedData/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP",
                    type: 'POST',
                    data: JSON.stringify(CashierPayment),
                    contentType: "application/json;charset=utf-8",
                    success: function (data) {
    ...
    $("#BtnVoidBySelected").click(function (e) {
        ...
        alertify.confirm("Are you sure want to Void by Selected Data ?", function (e) {
            if (e) {
                ...
                $.ajax({
                    url: window.location.origin + "/Radsoft/Cashier/Cashier_ValidateOtherTransactionBySelected/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/CP",
                    type: 'POST',
                    data: JSON.stringify(CashierPayment),
                    contentType: "application/json;charset=utf-8",
                    success: function (data) {
                        if (data == "") {
                            $.ajax({
                                url: window.location.origin + "/Radsoft/Cashier/VoidBySelectedData/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP",
                                type: 'POST',
                                data: JSON.stringify(CashierPayment),
                                contentType: "application/json;charset=utf-8",
                                success: function (data) {
    ...
    $("#BtnPostingBySelected").click(function () {
        ...
        alertify.confirm("Are you sure want to Posting by Selected Data ?", function (e) {
            if (e) {
                var _urlValidate = "";
                //if (_GlobClientCode == "01") {
                //    _urlValidate = window.location.origin + "/Radsoft/Cashier/ValidateCheckPostingBySelectedCashierByReference/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP";
                //} else {
                //    _urlValidate = window.location.origin + "/Radsoft/Cashier/ValidateCheckPostingCashier/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP";
                //}
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data == "") {
                                ...
                                {
                                    $.ajax({
                                        url: window.location.origin + "/Radsoft/Cashier/ValidateCheckStatusPosting/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + "CP",
                                        type: 'GET',
                                        contentType: "application/json;charset=utf-8",
                                        success: function (data) {
                                            if (data == "") {
    ...
    function PostingBySelected()
    {
        ...
        $.ajax({
            url: window.location.origin + "/Radsoft/Cashier/PostingBySelectedData/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP",
            type: 'POST',
            data: JSON.stringify(CashierPayment),
            contentType: "application/json;charset=utf-8",
            success: function (data) {
            ...
            if (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == "") {
                            $.ajax({
                                url: window.location.origin + "/Radsoft/Cashier/ReviseBySelectedData/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy") + "/CP",
                                type: 'GET',
                                contentType: "application/json;charset=utf-8",
                                success: function (data) {
                                    alertify.alert(data);
