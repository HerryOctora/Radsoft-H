$(document).ready(function () {
    document.title = 'FORM RL510CBond';
    //Global Variabel
    var win;
    var winOldData;
    var tabindex;
    ...
    function initWindow() {
        ...
        win = $("#WinRL510CBond").kendoWindow({
            height: 600,
            title: "RL510CBond Detail",
            visible: false,
            width: 1200,
            modal: true,
            open: function (e) {
    ...
    var GlobValidator = $("#WinRL510CBond").kendoValidator().data("kendoValidator");
    ...
    function showDetails(e) {
        if (e == null) {
            ...
            e.handled = true;
            var grid;
            grid = $("#gridRL510CBondApproved").data("kendoGrid");
        ...
        $("#ObRating").val(dataItemX.ObRating);
    ...
    function initGrid() {
        ...
        $("#gridRL510CBondApproved").empty();
        if ($("#DateFrom").val() == null || $("#DateFrom").val() == "" || $("#DateTo").val() == null || $("#DateTo").val() == "") {
            alertify.alert("Please Fill Date");
        }
        else {

            var RL510CBondApprovedURL = window.location.origin + "/Radsoft/RL510CBond/GetDataByDateFromTo/" + sessionStorage.getItem("user") + "/" + sessionStorage.getItem("id") + "/" + 2 + "/" + kendo.toString($("#DateFrom").data("kendoDatePicker").value(), "MM-dd-yy") + "/" + kendo.toString($("#DateTo").data("kendoDatePicker").value(), "MM-dd-yy"),
            dataSourceApproved = getDataSource(RL510CBondApprovedURL);

        }

        var grid = $("#gridRL510CBondApproved").kendoGrid({
            ...
            columns: [
                ...
                //{ field: "RL510CBondPK", title: "SysNo.", width: 95 },
                ...
                { field: "ObRating", title: "ObRating", width: 200 },
