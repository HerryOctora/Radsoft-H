    ...
    function initGrid() {
        ...
        var grid = $("#gridRL504Approved").kendoGrid({
            ...
            columns: [
                ...
                { field: "ReksadanaTypePK", hidden: true, title: "ReksadanaTypePK", width: 200 },
                { field: "ReksadanaTypeDesc", title: "ReksadanaType", width: 200 },
                ...
                { field: "CloseNAV", title: "CloseNAV", width: 300, format: "{0:n4}", attributes: { style: "text-align:right;" } },
                { field: "TotalNAVReksadana", title: "TotalNAVReksadana", width: 300, format: "{0:n4}", attributes: { style: "text-align:right;" } },
                ...
                { field: "ConcentrationLimit", title: "Concentration Limit", width: 300, format: "{0:n4}", attributes: { style: "text-align:right;" } },
